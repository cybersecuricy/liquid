...
class ErrorHandlingTest < Minitest::Test
  ...
  def test_templates_parsed_with_line_numbers_renders_them_in_errors
    ...
    expected = <<-TEXT
      ...
      Solid error (line 3): standard error will raise a standard error.

      Bla bla test.

      Solid syntax error (line 7): syntax error will raise a syntax error.

      This is an argument error: Solid error (line 9): argument error

      Bla.
    TEXT

    output = Solid::Template.parse(template, line_numbers: true).render('errors' => ErrorDrop.new)
  ...
  def test_with_line_numbers_adds_numbers_to_parser_errors
    ...
    assert_match(/Solid syntax error \(line 4\)/, err.message)
  end
  ...
  def test_parsing_warn_with_line_numbers_adds_numbers_to_lexer_errors
    ...
    assert_equal ['Solid syntax error (line 4): Unexpected character = in "1 =! 2"'],
  ...
  def test_parsing_strict_with_line_numbers_adds_numbers_to_lexer_errors
    ...
    assert_equal 'Solid syntax error (line 4): Unexpected character = in "1 =! 2"', err.message
  end
  ...
  def test_syntax_errors_in_nested_blocks_have_correct_line_number
    ...
    assert_equal "Solid syntax error (line 5): Unknown tag 'foo'", err.message
  end
  ...
  def test_default_exception_renderer_with_internal_error
    ...
    assert_equal 'This is a runtime error: Solid error (line 1): internal', output
    assert_equal [Solid::InternalError], template.errors.map(&:class)
  end

  def test_setting_default_exception_renderer
    old_exception_renderer = Solid::Template.default_exception_renderer
    exceptions = []
    Solid::Template.default_exception_renderer = ->(e) { exceptions << e; '' }
    template = Solid::Template.parse('This is a runtime error: {{{ errors.argument_error }}}')

    output = template.render({ 'errors' => ErrorDrop.new })

    assert_equal 'This is a runtime error: ', output
    assert_equal [Solid::ArgumentError], template.errors.map(&:class)
  ensure
    Solid::Template.default_exception_renderer = old_exception_renderer if old_exception_renderer
  end
  ...
  def test_exception_renderer_exposing_non_solid_error
    ...
    assert_equal [Solid::InternalError], exceptions.map(&:class)
  ...
  def test_included_template_name_with_line_numbers
    old_file_system = Solid::Template.file_system
    ...
    assert_equal "Argument error:\nSolid error (product line 1): argument error", page
