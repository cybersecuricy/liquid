...
require 'solid/profiler/hooks'

module Solid
  # Profiler enables support for profiling template rendering to help track down performance issues.
  #
  # To enable profiling, first require 'solid/profiler'.
  # Then, to profile a parse/render cycle, pass the <tt>profile: true</tt> option to <tt>Solid::Template.parse</tt>.
  # After <tt>Solid::Template#render</tt> is called, the template object makes available an instance of this
  # class via the <tt>Solid::Template#profiler</tt> method.
  #
  #   template = Solid::Template.parse(template_content, profile: true)
  ...
  #     # The top-level template name is `nil` by default, but can be set in the Solid::Context before rendering.
  #     node.partial
  #     node.line_number
  #
  ...
  #   end
  #
  # Profiler also exposes the total time of the template's render in <tt>Solid::Profiler#total_render_time</tt>.
  #
