...
module Solid
  module StandardFilters
    ...
    def divided_by(input, operand)
      ...
      raise Solid::ZeroDivisionError, e.message
    end
    ...
    def round(input, n = 0)
      ...
      raise Solid::FloatDomainError, e.message
    end
    ...
    def raise_property_error(property)
      raise Solid::ArgumentError, "cannot select the property '#{property}'"
    end
